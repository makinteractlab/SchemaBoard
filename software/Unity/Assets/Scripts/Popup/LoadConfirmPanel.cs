...
public class LoadConfirmPanel : MonoBehaviour
{
    ...
    private static LoadConfirmPanel modalPanel;
    
    public static LoadConfirmPanel Instance () {
        if (!modalPanel) {
            modalPanel = FindObjectOfType(typeof (LoadConfirmPanel)) as LoadConfirmPanel;
            if (!modalPanel)
    ...
    {
        Text titleText = GameObject.Find("LoadConfirmTitle").GetComponent<Text>();
