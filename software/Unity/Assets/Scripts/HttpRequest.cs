...
public class HttpRequest : MonoBehaviour {
    ...
    IEnumerator GetRequestJson(string _url, string _data)
    {
        ...
        if (www.isNetworkError) {
            ...
            string path = @"D:/Works/Git/RetroBreadboard/software/BreadboardSimulator/data/circuit5.json";
    ...
    IEnumerator GetRequestText(string _url, string _data)
    {
        ...
        if (www.isNetworkError) {
            ...
            string path = @"D:/Works/Git/RetroBreadboard/software/BreadboardSimulator/data/circuit5.sch";
            try {
                using (StreamReader reader = new StreamReader(path)) {
                    string line;
                    while((line = reader.ReadLine()) !=null) {
